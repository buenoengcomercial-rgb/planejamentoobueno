...
export default function WarehouseBudgetMaterialsTab({ project }: { project: Project }) {
  ...
  return <section className="space-y-3">
    <div className="rounded-xl border bg-card p-3"><h3 className="font-semibold">Materiais do orçamento</h3><p className="mt-1 text-xs text-muted-foreground">Consulta por capítulo principal. Contratado considera o contrato vigente, já reduzido pelas supressões ativas e acrescido somente por aditivos formalmente contratados. Retirado soma requisições entregues vinculadas ao capítulo.</p></div>
