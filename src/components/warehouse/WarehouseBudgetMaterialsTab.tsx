...
export default function WarehouseBudgetMaterialsTab({ project }: { project: Project }) {
  ...
  return <section className="space-y-3">
    <div className="rounded-xl border bg-card p-3"><h3 className="font-semibold">Materiais do orçamento</h3><p className="mt-1 text-xs text-muted-foreground">Consulta por capítulo principal. Retirado líquido soma somente requisições entregues vinculadas ao capítulo e desconta devoluções operacionais. Acréscimos e supressões de aditivos ativos permanecem destacados, inclusive antes da contratação.</p></div>
