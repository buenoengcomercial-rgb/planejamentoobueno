  ...
  it('remove os históricos e preserva o cadastro completo dos equipamentos', () => {
    const project: Project = {
      ...
      warehouse: {
        ...
        fiscalNotes: [{ id: 'nf-1', invoiceNumber: '1', supplierName: 'Fornecedor', issueDate: '2026-08-18', status: 'aprovada', items: [], createdAt: '2026-08-18', updatedAt: '2026-08-18', totalAmount: 0, origin: 'upload', sourceFileName: 'nf.pdf' }],
        materialLinks: [],
    ...
    expect(result.project.materialPriceHistory).toEqual([]);
